...
return array(
    ...
    'Override default template with your own template. Enter the folder with template, e.g.: _amforms/email' => 'Overschrijf de standaard template met uw eigen template. Voer de map met de template in, bijv.: _amforms/email',
